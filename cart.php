...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="../index.php">ASOFT Foodie</a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            ...
            <form class="form-inline my-2 my-md-0">
                <a href="../sellerSignUp.php"><button type="button" class="btn btn-lg btn-block btn-primary">ASOFT Foodie Business <i class="fas fa-arrow-circle-right"></i></button></a>
            </form>
        </div>
    </div>
</nav>
                    ...
                    <tbody>
                        ...
                        $query = mysqli_query($con, "
                            SELECT 
                                ...
                                tbfood.fldimage, 
                                tblcart.fld_cart_id, 
                                tblcart.fld_product_id, 
                                tblcart.fld_customer_id, 
                                COUNT(tblcart.fld_product_id) AS item_count
                            FROM 
                                tbfood 
                            INNER JOIN 
                                tblcart 
                            ON 
                                tbfood.food_id = tblcart.fld_product_id 
                            WHERE 
                                tblcart.fld_customer_id = '$cust_id'
                            GROUP BY 
                                tblcart.fld_product_id, tblcart.fld_customer_id
                        ");
                        $re = mysqli_num_rows($query);
                        if ($re) {
                        ...
                        ?>
                        <tr>
                            <td><img src="../image/restaurant/<?php echo $em . "/foodimages/" . $res['fldimage']; ?>" height="80px" width="100px"></td>
                            ...
                            <td>
                                <form method="post" enctype="multipart/form-data">
                                    <button type="submit" name="del" value="<?php echo $res['fld_cart_id']; ?>" class="btn btn-danger">Delete</button>
                                </form>
                            </td>
                        </tr>
                        <?php
                                $total += $res['cost'] * $res['item_count'];
                                $gtotal[] = $total;
                            }
                        ?>
                        <tr>
                            <td colspan="6"><h5 style="color:red;">Grand total</h5></td>
                            <td><h5><i class="fas fa-rupee-sign"></i>&nbsp;<?php echo end($gtotal); ?></h5></td>
							</tr>
							<tr>
							 
                            <td colspan="4" >
                                <button type="button" style=" font-weight:bold; text-transform:uppercase;" class="btn btn-info">
                                    <a href="../index.php" style="color:white;text-decoration:none;">Add more items to cart</a>
                                </button>
                            </td>
            ...
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        ...
                        <?php
                        $quer_res = mysqli_query($con, "SELECT * FROM tblorder WHERE fld_email_id='$cust_id' AND fldstatus='In Process'");
